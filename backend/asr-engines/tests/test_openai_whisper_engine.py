...
from asr_engines.enums import ModelType
from asr_engines.openai_whisper_engine import OpenAIWhisperEngine
...
class TestOpenAIWhisperEngine(unittest.TestCase):
    ...
    @patch('asr_engines.openai_whisper_engine.whisper.load_model', autospec=True)
